...
struct viennacl_operations {
  ...
  struct scale_sum2 {
    ...
    void operator()(viennacl::vector<T1>& v1, const viennacl::vector<T2>& v2,
      ...
      static generator::custom_operation op(sym_v1 = sym_a1 * sym_v2 + sym_a2 * sym_v3);

      ocl::enqueue(op(v1, const_cast<viennacl::vector<T2>&>(v2), const_cast<viennacl::vector<T3>&>(v3),
                      const_cast<Fac1&>(m_alpha1), const_cast<Fac2&>(m_alpha2)));
    }
  ...
  struct scale_sum3 {
    ...
    void operator()(viennacl::vector<T1>& v1, const viennacl::vector<T2>& v2,
                    const viennacl::vector<T3>& v3, const viennacl::vector<T4>& v4) const {
      using namespace viennacl;
      ...
      static generator::custom_operation op(sym_v1 =
                                                sym_a1 * sym_v2 + sym_a2 * sym_v3 + sym_a3 * sym_v4);

      ocl::enqueue(op(v1, const_cast<viennacl::vector<T2>&>(v2), const_cast<viennacl::vector<T3>&>(v3),
                      const_cast<viennacl::vector<T4>&>(v4), const_cast<Fac1&>(m_alpha1),
                      const_cast<Fac2&>(m_alpha2), const_cast<Fac3&>(m_alpha3)));
    }
  ...
  struct scale_sum4 {
    ...
    void operator()(viennacl::vector<T1>& v1, const viennacl::vector<T2>& v2,
                    const viennacl::vector<T3>& v3, const viennacl::vector<T4>& v4,
                    const viennacl::vector<T5>& v5) const {
      using namespace viennacl;
      ...
      static generator::custom_operation op(sym_v1 = sym_a1 * sym_v2 + sym_a2 * sym_v3 +
                                                sym_a3 * sym_v4 + sym_a4 * sym_v5);

      ocl::enqueue(op(v1, const_cast<viennacl::vector<T2>&>(v2), const_cast<viennacl::vector<T3>&>(v3),
                      const_cast<viennacl::vector<T4>&>(v4), const_cast<viennacl::vector<T5>&>(v5),
                      const_cast<Fac1&>(m_alpha1), const_cast<Fac2&>(m_alpha2),
  ...
  struct scale_sum5 {
    ...
    void operator()(viennacl::vector<T1>& v1, const viennacl::vector<T2>& v2,
                    const viennacl::vector<T3>& v3, const viennacl::vector<T4>& v4,
                    const viennacl::vector<T5>& v5, const viennacl::vector<T6>& v6) const {
      using namespace viennacl;
      ...
      static generator::custom_operation op(sym_v1 = sym_a1 * sym_v2 + sym_a2 * sym_v3 +
                                                sym_a3 * sym_v4 + sym_a4 * sym_v5 + sym_a5 * sym_v6);

      ocl::enqueue(op(v1, const_cast<viennacl::vector<T2>&>(v2), const_cast<viennacl::vector<T3>&>(v3),
                      const_cast<viennacl::vector<T4>&>(v4), const_cast<viennacl::vector<T5>&>(v5),
                      const_cast<viennacl::vector<T6>&>(v6), const_cast<Fac1&>(m_alpha1),
                      const_cast<Fac2&>(m_alpha2), const_cast<Fac3&>(m_alpha3),
                      const_cast<Fac4&>(m_alpha4), const_cast<Fac5&>(m_alpha5)));
    }
