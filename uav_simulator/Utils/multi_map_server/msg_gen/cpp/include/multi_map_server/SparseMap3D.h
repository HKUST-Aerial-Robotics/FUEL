...
template <class ContainerAllocator>
struct IsMessage< ::multi_map_server::SparseMap3D_<ContainerAllocator> > : public TrueType {};
template <class ContainerAllocator>
...
template <class ContainerAllocator>
struct HasHeader< ::multi_map_server::SparseMap3D_<ContainerAllocator> > : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::multi_map_server::SparseMap3D_<ContainerAllocator> > : public TrueType {};
}  // namespace message_traits
}  // namespace ros
...
template <class ContainerAllocator>
struct Serializer< ::multi_map_server::SparseMap3D_<ContainerAllocator> > {
