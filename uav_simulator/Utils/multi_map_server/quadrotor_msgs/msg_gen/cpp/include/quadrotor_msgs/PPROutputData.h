...
template <class ContainerAllocator>
struct IsMessage< ::quadrotor_msgs::PPROutputData_<ContainerAllocator> > : public TrueType {};
template <class ContainerAllocator>
...
template <class ContainerAllocator>
struct HasHeader< ::quadrotor_msgs::PPROutputData_<ContainerAllocator> > : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::quadrotor_msgs::PPROutputData_<ContainerAllocator> > : public TrueType {};
}  // namespace message_traits
}  // namespace ros
...
template <class ContainerAllocator>
struct Serializer< ::quadrotor_msgs::PPROutputData_<ContainerAllocator> > {
