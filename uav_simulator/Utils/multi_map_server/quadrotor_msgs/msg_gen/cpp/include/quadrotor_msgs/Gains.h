...
template <class ContainerAllocator>
struct IsMessage< ::quadrotor_msgs::Gains_<ContainerAllocator> > : public TrueType {};
template <class ContainerAllocator>
...
template <class ContainerAllocator>
struct IsFixedSize< ::quadrotor_msgs::Gains_<ContainerAllocator> > : public TrueType {};
}  // namespace message_traits
}  // namespace ros
...
template <class ContainerAllocator>
struct Serializer< ::quadrotor_msgs::Gains_<ContainerAllocator> > {
