...
std::ostream& operator<<(std::ostream& s, const ::quadrotor_msgs::SO3Command_<ContainerAllocator>& v) {
  ros::message_operations::Printer< ::quadrotor_msgs::SO3Command_<ContainerAllocator> >::stream(s, "",
                                                                                                v);
  return s;
}
...
template <class ContainerAllocator>
struct IsMessage< ::quadrotor_msgs::SO3Command_<ContainerAllocator> > : public TrueType {};
template <class ContainerAllocator>
...
template <class ContainerAllocator>
struct HasHeader< ::quadrotor_msgs::SO3Command_<ContainerAllocator> > : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::quadrotor_msgs::SO3Command_<ContainerAllocator> > : public TrueType {};
}  // namespace message_traits
}  // namespace ros
