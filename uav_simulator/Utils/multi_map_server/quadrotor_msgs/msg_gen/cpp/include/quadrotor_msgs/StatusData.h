...
struct StatusData_ {
  ...
  StatusData_() : header(), loop_rate(0), voltage(0.0), seq(0) {
  }

  StatusData_(const ContainerAllocator& _alloc) : header(_alloc), loop_rate(0), voltage(0.0), seq(0) {
  }
...
std::ostream& operator<<(std::ostream& s, const ::quadrotor_msgs::StatusData_<ContainerAllocator>& v) {
  ros::message_operations::Printer< ::quadrotor_msgs::StatusData_<ContainerAllocator> >::stream(s, "",
                                                                                                v);
  return s;
}
...
template <class ContainerAllocator>
struct IsMessage< ::quadrotor_msgs::StatusData_<ContainerAllocator> > : public TrueType {};
template <class ContainerAllocator>
struct IsMessage< ::quadrotor_msgs::StatusData_<ContainerAllocator> const> : public TrueType {};
template <class ContainerAllocator>
struct MD5Sum< ::quadrotor_msgs::StatusData_<ContainerAllocator> > {
  ...
  static const char* value(const ::quadrotor_msgs::StatusData_<ContainerAllocator>&) {
    return value();
  }
...
template <class ContainerAllocator>
struct HasHeader< ::quadrotor_msgs::StatusData_<ContainerAllocator> > : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::quadrotor_msgs::StatusData_<ContainerAllocator> > : public TrueType {};
}  // namespace message_traits
}  // namespace ros
...
template <class ContainerAllocator>
struct Serializer< ::quadrotor_msgs::StatusData_<ContainerAllocator> > {
...
struct Printer< ::quadrotor_msgs::StatusData_<ContainerAllocator> > {
  ...
  static void stream(Stream& s, const std::string& indent,
                     const ::quadrotor_msgs::StatusData_<ContainerAllocator>& v) {
    s << indent << "header: ";
    s << std::endl;
