...
std::ostream& operator<<(std::ostream& s, const ::quadrotor_msgs::TRPYCommand_<ContainerAllocator>& v) {
  ros::message_operations::Printer< ::quadrotor_msgs::TRPYCommand_<ContainerAllocator> >::stream(s, "",
                                                                                                 v);
  return s;
}
...
template <class ContainerAllocator>
struct IsMessage< ::quadrotor_msgs::TRPYCommand_<ContainerAllocator> > : public TrueType {};
template <class ContainerAllocator>
...
template <class ContainerAllocator>
struct HasHeader< ::quadrotor_msgs::TRPYCommand_<ContainerAllocator> > : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::quadrotor_msgs::TRPYCommand_<ContainerAllocator> > : public TrueType {};
}  // namespace message_traits
}  // namespace ros
...
template <class ContainerAllocator>
struct Serializer< ::quadrotor_msgs::TRPYCommand_<ContainerAllocator> > {
